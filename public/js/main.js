...
//    'angular-translate-storage-cookie': '../../bower_components/angular-translate-storage-cookie/angular-translate-storage-cookie.min',
    ...
    'jquery-tagsinput': '../bower_components/jquery.tagsinput/jquery.tagsinput.min',
    raphael:'../bower_components/raphael/raphael-min',
    'morris-min': '../bower_components/morris/morris.min',
    'jquery-flot' : '../bower_components/flot/jquery.flot',
    'jquery-flot-resize' : '../bower_components/flot/jquery.flot.resize',
...
//  });
//});
require(['bootstrap', 'jquery-tagsinput',
  'raphael','morris-min','jquery-flot',
  'jquery-flot-resize',
  'jquery-flot-pie'], function() {
});